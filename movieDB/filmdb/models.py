...
class Film(models.Model):
    ...
    award = models.CharField(max_length=128, default='Blank', null=True,help_text='film awards', blank=True)
    country = models.ManyToManyField(Country, default=1, blank=True)
    language = models.ManyToManyField(Language)
    plot = models.TextField(max_length=1000, help_text="Film plot", null=True, blank=True)
